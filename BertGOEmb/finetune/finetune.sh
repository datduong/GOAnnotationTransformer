...
CUDA_VISIBLE_DEVICES=1 python3 -u finetune_on_pregenerated.py --bert_vocab $bert_vocab --pregenerated_data $output_dir --bert_model $bert_model --output_dir $output_dir --epochs 100 --train_batch_size 8 --config_name $config_name --config_override --fp16 
