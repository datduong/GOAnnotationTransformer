...
for method1 in ProtAnnotTypeLarge/YesPpi100YesTypeScaleFreezeBert12Ep10e10Drop0.1 ; do
  ...
  for onto in mf cc bp ; do
    ...
    save_file=$main_dir/$onto/fold_1/2embPpiAnnotE256H1L12I512Set0/$method1/TrainLargeEnsemble$blast
    mkdir $save_file
  ...
  path_out_mf=$main_dir/mf/fold_1/2embPpiAnnotE256H1L12I512Set0/$method1/TrainLargeEnsemble$blast/mf_count.txt
  path_out_cc=$main_dir/cc/fold_1/2embPpiAnnotE256H1L12I512Set0/$method1/TrainLargeEnsemble$blast/cc_count.txt
  path_out_bp=$main_dir/bp/fold_1/2embPpiAnnotE256H1L12I512Set0/$method1/TrainLargeEnsemble$blast/bp_count.txt

  final_dir=$server/deepgo/data/BertNotFtAARawSeqGO/EvalLabelByGroup/TrainLargeEnsemble$blast
  mkdir $final_dir
  cd $final_dir
