...
choice='Yes3dYesAaTypeLabelBertAveL12Frac70' #'Yes3dYesAaTypeLabelBertAveL12' #Epo1000bz6' #?'NoPpiYesAaTypeLabelBertAveL12' 
...
cache_name='DataWithMotif3dInPickle' # 'DataWithMotif3dInPickle' 

save_every=7000

## define parameters for mf-ontology
checkpoint=125307 #266793 #163904 #? 670152 ## use this when we want to test a specific checkpoint
