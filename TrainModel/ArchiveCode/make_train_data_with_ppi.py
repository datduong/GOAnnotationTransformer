...
for data_type in ['train','dev','test']: 
  for ontology in ['cc','bp','mf']: 
    ...
    fout = "/u/scratch/d/datduong/deepgo/data/train/fold_1/TokenClassify/"+data_type+"-"+ontology+"-ppi.csv"
    ...
    for index,row in df.iterrows(): 
      ...
      fout.write(new_seq + "\t" + " ".join(go_list)+ "\t" + " ".join(row['Prot Emb'].strip().split(';')) + "\n")
