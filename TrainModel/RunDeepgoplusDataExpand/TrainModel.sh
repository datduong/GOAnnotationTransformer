...
checkpoint=408936 ## use this when we want to test a specific checkpoint
...
for ontology in mf ; do 
  ...
  data_text_location='/local/datdb/deepgoplus/ExpandGoSet/cafa3-data/SeqLenLess1000'
