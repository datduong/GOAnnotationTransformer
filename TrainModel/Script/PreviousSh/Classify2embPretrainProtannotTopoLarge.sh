...
for ontology in 'mf' 'cc' 'bp' ; do
  ...
  train_data_file='/local/datdb/deepgo/dataExpandGoSet/train/fold_1/ProtAnnotTypeTopoData/train-'$ontology'-input.tsv' ## okay to call it as long as it has ppi
