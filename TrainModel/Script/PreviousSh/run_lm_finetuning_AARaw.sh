...
train_data_file='/local/datdb/deepgo/data/BertFtAARaw/seq_finetune_aa_train.txt'
...
# CUDA_VISIBLE_DEVICES=1 python3 -u run_lm_finetuning.py --block_size 524 --mlm --bert_vocab $bert_vocab --train_data_file $train_data_file --output_dir $output_dir --num_train_epochs 20 --per_gpu_train_batch_size 8 --config_name $config_name --config_override --do_train --model_type bert --overwrite_output_dir --save_steps 20000

# eval_data_file
# CUDA_VISIBLE_DEVICES=2 python3 -u run_lm_finetuning.py --block_size 524 --mlm --bert_vocab $bert_vocab --train_data_file $train_data_file --eval_data_file $eval_data_file --output_dir $output_dir --num_train_epochs 20 --per_gpu_eval_batch_size 8 --config_name $config_name --do_eval --model_type bert --overwrite_output_dir --save_steps 20000 --model_name_or_path $last_save


## continue training 
CUDA_VISIBLE_DEVICES=5 python3 -u run_lm_finetuning.py --learning_rate 0.0001 --config_override --block_size 1048 --mlm --bert_vocab $bert_vocab --train_data_file $train_data_file --output_dir $output_dir --num_train_epochs 100 --per_gpu_train_batch_size 8 --per_gpu_eval_batch_size 8 --config_name $config_name --do_train --model_type bert --overwrite_output_dir --save_steps 10000 --logging_steps 10000 --evaluate_during_training --eval_data_file $eval_data_file > $output_dir/train_point.txt
