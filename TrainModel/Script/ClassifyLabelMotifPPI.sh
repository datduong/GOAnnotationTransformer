...
for ontology in cc ; do # 'cc' 'bp'
  ...
  train_masklm_data='/local/datdb/deepgo/dataExpandGoSet16Jan2020/train/fold_1/ProtAnnotTypeData/train-'$ontology'-input.tsv' ## okay to call it as long as it has ppi
