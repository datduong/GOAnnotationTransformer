...
choice='GeluE768H6L8I768PretrainLabelDrop0.2'
for ontology in 'mf' 'cc' ; do
  last_save=$server/'deepgo/data/BertNotFtAARawSeqGO/'$ontology/'fold_1/2emb'$choice
  output_dir=$server/'deepgo/data/BertNotFtAARawSeqGO/'$ontology/'fold_1/2emb'$choice
  mkdir $output_dir
