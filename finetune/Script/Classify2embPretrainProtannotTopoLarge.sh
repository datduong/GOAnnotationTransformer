...
for ontology in 'mf' 'cc' ; do
  ...
  train_masklm_data='/local/datdb/deepgo/dataExpandGoSet/train/fold_1/ProtAnnotTypeTopoData/train-'$ontology'-prot-annot-input.tsv' ## okay to call it as long as it has ppi
  eval_masklm_data='/local/datdb/deepgo/dataExpandGoSet/train/fold_1/ProtAnnotTypeTopoData/dev-'$ontology'-prot-annot-input.tsv'
  ...
  #   eval_masklm_data='/local/datdb/deepgo/dataExpandGoSet/train/fold_1/ProtAnnotTypeTopoData/'$test_data'-'$ontology'-prot-annot-input.tsv'
