...
choice='2embPpiAnnotE256H1L12I512Set0/YesPpiMuhaoYesTypeScaleFreezeBert12Ep10e10Drop0.1' # Lr5e-5 Dr0.2
model_type='ppi'
...
for ontology in 'cc' ; do # 'cc' 'bp'
  ...
  eval_masklm_data='/local/datdb/deepgo/data/train/fold_1/ProtAnnotTypeData/dev-'$ontology'-input-muhao.tsv'
  ...
  #   # eval_masklm_data='/local/datdb/deepgo/data/train/fold_1/ProtAnnotTypeData/'$test_data'-'$ontology'-input-muhao.tsv'
