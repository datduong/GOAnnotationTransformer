...
for onto in cc bp ; do 
  mkdir /local/datdb/deepgo/data/BertNotFtAARawSeqGO/$onto/fold_1/2embPpiAnnotE256H1L12I512Set0/ProtAnnotTypeLargeTopo/YesPpiYesTypeScaleFreezeBert12Ep10e10Drop0.2
  cd /local/datdb/deepgo/data/BertNotFtAARawSeqGO/$onto/fold_1/2embPpiAnnotE256H1L12I512Set0/ProtAnnotTypeLargeTopo/YesPpiYesTypeScaleFreezeBert12Ep10e10Drop0.2
  scp /local/datdb/deepgo/data/BertNotFtAARawSeqGO/$onto/fold_1/2embPpiAnnotE256H1L12I512Set0/ProtAnnotTypeLargeTopo/YesPpiYesTypeScaleFreezeBert12Ep10e10Drop0.1/vocab* .
  scp /local/datdb/deepgo/data/BertNotFtAARawSeqGO/$onto/fold_1/2embPpiAnnotE256H1L12I512Set0/ProtAnnotTypeLargeTopo/YesPpiYesTypeScaleFreezeBert12Ep10e10Drop0.1/config.json .
done 
