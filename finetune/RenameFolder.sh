...
for onto in mf cc bp ; do 
  mkdir /local/datdb/deepgo/data/BertNotFtAARawSeqGO/$onto/fold_1/2embPpiAnnotE256H1L12I512Set0/YesPpi100NoTypeScaleFreezeBert12Ep10e10Drop0.1
  cd /local/datdb/deepgo/data/BertNotFtAARawSeqGO/$onto/fold_1/2embPpiAnnotE256H1L12I512Set0/YesPpi100NoTypeScaleFreezeBert12Ep10e10Drop0.1
