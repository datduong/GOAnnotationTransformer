...
python3 pregenerate_training_data.py --bert_vocab $bert_vocab --train_corpus $train_corpus --bert_model bert-base-cased --output_dir $output_dir --epochs_to_generate 10 --max_seq_len 512
