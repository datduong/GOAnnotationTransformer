...
for ontology in mf ; do 
  ...
  train_data_file='/local/datdb/UniprotJan2020/AddIsA/TrainDevTest/'$ontology'-train-input.tsv' ## okay to call it as long as it has ppi
  eval_data_file='/local/datdb/UniprotJan2020/AddIsA/TrainDevTest/'$ontology'-dev-input.tsv'
  label_2test='/local/datdb/UniprotJan2020/AddIsA/'$ontology'-label.tsv'
